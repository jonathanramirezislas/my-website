...
export const About = () => {
	...
	return (
		<>
			<Parallax
				bgImage={image1}
				className={'z-10 py-3 px-7 sm:py-1 md:py-6 md:px-14 h-2/5 sm:h-2/4 md:h-full md:pt-2 '+ColorBG } 
				strength={150}
			>
				<div className="flex-1 w-3/4 sm:w-2/4 md:max-w-2xl md:mx-auto md:my-10">
