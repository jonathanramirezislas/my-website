			...
			<div className="fixed z-40 grid w-full h-12 grid-cols-2 bg-black border-b-2 border-red-500">
				<div>
					<nav className="flex-row w-full h-12 p-2 text-indigo-100 color-white md:justify-between">
						...
						<ul
							className={
								'bg-black bg-opacity-50 md:bg-opacity-100 	border-b-4 border-r-4  border-black md:border-none	md:ml-2 flex-row md:flex w-11/12  text-white ' +
						...
						>
							<li
								...
								className={
									...
									'font-bold pr-5 mt-10 md:mt-0 cursor-pointer hover:text-yellow-300'
								}
							>
								<a> Home </a>
							</li>
							...
							<li
								...
								className={
									...
									'font-bold font-sans pr-5 mt-10 md:mt-0 cursor-pointer hover:text-yellow-300'
								}
							>
								<a>About</a>
							</li>
